...
class MapObject(BaseObject):
    ...
    __slots__ = ()
    _hx_fields = []
    _hx_methods = [u"__getLocation", u"__distance", u"__inRange"]
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = BaseObject


    def _hx___getLocation(self):
        raise _HxException(u"Unimplemented!")

    def _hx___distance(self,other):
        return self._hx___getLocation()._hx___distance(other)

    def _hx___inRange(self,other,range):
        if ((self._hx___getLocation() is not None) and ((other._hx___getLocation() is not None))):
            return self._hx___getLocation()._hx___inRange(other._hx___getLocation(),range)
        else:
            return False
...
class GameObject(MapObject):
    ...
    __slots__ = (u"owner", u"id", u"unique_id", u"already_acted", u"_hx___location")
    _hx_fields = [u"owner", u"id", u"unique_id", u"already_acted", u"__location"]
    _hx_methods = [u"equals", u"hashCode", u"toString", u"__getLocation"]
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = MapObject
    ...
    def toString(self):
        return ((((((u"{" + HxOverrides.stringOrNull(self.type)) + u" Id: ") + Std.string(self.id)) + u", Owner: ") + Std.string(self.owner.id)) + u"}")

    def _hx___getLocation(self):
        return self._hx___location
...
class Iceberg(GameObject):
    ...
    __slots__ = (u"penguin_amount", u"_hx___penguin_group_max_speed", u"upgrade_value", u"upgrade_cost", u"level", u"upgrade_level_limit", u"cost_factor", u"_hx___can_upgrade_object", u"penguins_per_turn")
    _hx_fields = [u"penguin_amount", u"__penguin_group_max_speed", u"upgrade_value", u"upgrade_cost", u"level", u"upgrade_level_limit", u"cost_factor", u"__can_upgrade_object", u"penguins_per_turn"]
    ...
    def get_turns_till_arrival(self,destination):
        turns = (self._hx___distance(destination) / self._hx___penguin_group_max_speed)
        x = Math.ceil(turns)
        try:
            return int(x)
    ...
    def can_send_penguins(self,destination,penguinAmount):
        if (not Std._hx_is(destination,Iceberg)):
            return False
        if (((penguinAmount > self.penguin_amount) or ((self.penguin_amount < 1))) or ((destination == self))):
            return False
        return True
    ...
    def upgrade(self):
        BaseObject._game._addOrder(u"upgrade",self)
    ...
    def _hx_empty_init(_hx_o):
        ...
        _hx_o.level = None
        _hx_o.upgrade_level_limit = None
        _hx_o.cost_factor = None
        _hx_o._hx___can_upgrade_object = None
        _hx_o.penguins_per_turn = None
Iceberg._hx_class = Iceberg
_hx_classes[u"Iceberg"] = Iceberg
...
class Location(MapObject):
    ...
    _hx_methods = [u"__getLocation", u"equals", u"add", u"subtract", u"multiply", u"__add__", u"__sub__", u"__mul__", u"__rmul__", u"hashCode", u"toString", u"__inRange", u"__distance", u"towards"]
    ...
    def multiply(self,factor):
        ...
        x = (BaseObject._game._hx___rows / 2)
        final_row1 = None
        try:
            final_row1 = int(x)
        except Exception, _hx_e:
        ...
        x1 = (BaseObject._game._hx___cols / 2)
        final_col1 = None
        try:
            final_col1 = int(x1)
        except Exception, _hx_e:
    ...
    def _hx___inRange(self,other,range):
        return (self._hx___distance(other) <= range)

    def _hx___distance(self,other):
        loc = other._hx___getLocation()
    ...
    def towards(self,other,length):
        otherLocation = other._hx___getLocation()
        distance = self._hx___distance(otherLocation)
...
class ObjectParser(object):
    ...
    @staticmethod
    def _hx___loadVectorOfBaseObjects_Iceberg(args,ignored):
        instanceField = (None if ((len(args) == 0)) else args.pop())
        initValueArray = (None if ((len(args) == 0)) else args.pop())
        object = (None if ((len(args) == 0)) else args.pop())
        this1 = [None]*len(initValueArray)
...
class Game(BaseObject):
    ...
    __slots__ = (u"_hx___players", u"_hx___turnTime", u"_hx___turnStartTime", u"_hx___numPlayers", u"_hx___recoverErrors", u"_runnerFullStacktrace", u"max_points", u"max_turns", u"turn", u"_hx___me", u"_hx___enemies", u"_hx___orders", u"_hx___nativeAPI", u"_hx___neutral", u"_hx___rows", u"_hx___cols", u"_hx___all_icebergs")
    _hx_fields = [u"__players", u"__turnTime", u"__turnStartTime", u"__numPlayers", u"__recoverErrors", u"_runnerFullStacktrace", u"max_points", u"max_turns", u"turn", u"__me", u"__enemies", u"__orders", u"__nativeAPI", u"__neutral", u"__rows", u"__cols", u"__all_icebergs"]
    _hx_methods = [u"_nextTurn", u"_shouldRecoverErrors", u"isFilePosInBot", u"_addOrder", u"_addMoveOrder", u"_getActions", u"debug", u"get_myself", u"get_enemy", u"get_all_players", u"get_time_remaining", u"get_max_turn_time", u"get_neutral", u"get_all_penguin_groups", u"get_my_penguin_groups", u"get_enemy_penguin_groups", u"_moveOrder", u"get_all_icebergs", u"get_neutral_icebergs", u"get_my_icebergs", u"get_enemy_icebergs"]
    ...
    def _addOrder(self,orderType,actor,args = u""):
        if (args is None):
            args = u""
        orderOriginPosition = ((((u"{ \"file_name\": \"" + u"__UNKNOWN_FILE_NAME__") + u"\", \"line_number\": ") + Std.string(-1)) + u" }")
        ...
        while (_g < len(cs)):
            ...
            if (item.index == 2):
                ...
                if self.isFilePosInBot(method,file):
                    orderOriginPosition = ((((u"{ \"file_name\": \"" + HxOverrides.stringOrNull(HxString.substr(file,(file.rfind(u"/", 0, len(file)) + 1),None))) + u"\", \"line_number\": ") + Std.string(line)) + u" }")
                    actor.already_acted = True
                    break
        order = ((((((((u"{ \"order_type\": \"" + (u"null" if orderType is None else orderType)) + u"\", \"actor\": ") + Std.string(actor.unique_id)) + u", \"order_args\": {") + (u"null" if args is None else args)) + u"}, \"position\": ") + (u"null" if orderOriginPosition is None else orderOriginPosition)) + u" }")
    ...
    def get_all_penguin_groups(self):
        penguinGroups = list()
        _g = 0
        _g1 = self.get_enemy_penguin_groups()
        while (_g < len(_g1)):
            group = _g1[_g]
            _g = (_g + 1)
            penguinGroups.append(group)
        _g2 = 0
        _g11 = self.get_my_penguin_groups()
        while (_g2 < len(_g11)):
            group1 = _g11[_g2]
            _g2 = (_g2 + 1)
            penguinGroups.append(group1)
        return list(penguinGroups)

    def get_my_penguin_groups(self):
        this1 = self._hx___me.penguin_groups
        this2 = [None]*len(this1)
        r = this2
        haxe_ds__Vector_Vector_Impl_.blit(this1,0,r,0,len(this1))
        return r
    ...
    def get_enemy_penguin_groups(self):
        ...
        while (_g < len(_g1)):
            ...
            _g = (_g + 1)
            _g2 = 0
            _g3 = enemy_player.penguin_groups
            while (_g2 < len(_g3)):
                obj = _g3[_g2]
                _g2 = (_g2 + 1)
                penguinGroups.append(obj)
        return list(penguinGroups)
    ...
    def get_neutral_icebergs(self):
        return Game._hx___getObjectsOfPlayer_Iceberg(self._hx___all_icebergs,self._hx___neutral)

    def get_my_icebergs(self):
        return Game._hx___getObjectsOfPlayer_Iceberg(self._hx___all_icebergs,self._hx___me)
    ...
    def _hx___getObjectsOfEnemyPlayers_Iceberg(objects,player):
        ...
        while (_g < len(objects)):
            object = objects[_g]
            _g = (_g + 1)
            if ((object.owner != player) and ((object.owner.id != -1))):
                results.append(object)
        return list(results)

    @staticmethod
    def _hx___getObjectsOfPlayer_Iceberg(objects,player):
        results = list()
        _g = 0
        while (_g < len(objects)):
            object = objects[_g]
    ...
    def _hx_empty_init(_hx_o):
        ...
        _hx_o._hx___neutral = None
        _hx_o._hx___rows = None
...
class Player(BaseObject):
    ...
    __slots__ = (u"id", u"bot_name", u"score", u"penguin_groups", u"icebergs")
    _hx_fields = [u"id", u"bot_name", u"score", u"penguin_groups", u"icebergs"]
...
ObjectParser._hx___gameObjectClasses = []
ObjectParser._nativeAPI = None
Game.UNKNOWN_ORDER_FILE_NAME = u"__UNKNOWN_FILE_NAME__"
Game.UNKNOWN_ORDER_LINE_NUMBER = -1
